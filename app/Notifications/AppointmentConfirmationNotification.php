...
class AppointmentConfirmationNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject( 'Appointment Confirmation - Enta Salon 🎉' . $this->appointment->service->name)
            ->from('noreply@salonbliss.com')
            ->greeting('Hello ' . $notifiable->name . '!')
            ->line('Your appointment for ' . $this->appointment->service->name . ' has been confirmed!')
            // invoice
            ->line('Your payment of Rp.  ' . $this->appointment->total . ' has been processed.')
            ...
            ->line('Thank you for using Enta Salon! We hope to see you again soon.');
