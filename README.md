# Laravel based booking + CRM for Enta Salon
...
This project is a booking and CRM system for Enta Salon, a fictional hair salon. 
...
The postman collection for the API is available here: [Enta Salon.postman_collection.json](Enta Salon.postman_collection.json)
