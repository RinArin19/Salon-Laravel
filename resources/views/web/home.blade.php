...
>
  <div class="max-w-xl text-left ltr:sm:text-left rtl:sm:text-right">
    <h1 class="text-3xl font-extrabold sm:text-5xl text-neutral-700">
      Temukan Pengalaman Salon Sempurna Anda di
      <strong class="block font-extrabold text-pink-500">
        Enta Salon.      </strong>
    </h1>

    <p class="mt-4 max-w-lg sm:text-xl/relaxed">
      Temukan Dunia Kecantikan dan Keanggunan. Tingkatkan Gaya Anda di Enta Salon, Tempat Impian Menjadi Kenyataan.
         </p>
    ...
    {{-- <section class="bg-white pt-5">
      <div class="md:w-3/4 mx-auto">
        <div class="mx-auto text-center md:max-w-xl lg:max-w-3xl">
          ...
          <p class="mb-6 pb-2 text-gray-700 md:mb-12 md:pb-0">
            Berikut testimoni dari pelanggan yang telah mengunjungi salon kami.
          </p>
        </div>
        ...
        <div class="grid gap-6 text-center p-6 md:grid-cols-3 lg:gap-12">
          <div class="mb-12 md:mb-0">
            ...
            <p class="mb-4 text-neutral-500">
              ...
              Saya mendapatkan pengalaman yang paling menakjubkan di Enta Salon! Stafnya sangat ramah dan bersahabat, dan rambut saya terlihat sangat memukau. Saya menerima banyak pujian setelah perawatan dan saya tidak sabar untuk kembali lagi!
            </p>
          ...
          <div class="mb-12 md:mb-0">
            ...
            <p class="mb-4 text-neutral-500">
              ...
              "Saya mendapatkan potongan rambut terbaik dalam hidup saya di Enta Salon! Penata rambut mendengarkan dengan saksama apa yang saya inginkan dan kemudian memberikan potongan rambut yang melampaui ekspektasi saya. Saya merasa sangat dimanjakan dan diperhatikan selama seluruh proses. Saya tidak sabar untuk kembali lagi untuk janji temu berikutnya!
            </p>
            <ul class="mb-0 flex items-center justify-center">
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 text-yellow-500">
          ...
          <div class="mb-0">
            ...
            <p class="mb-4 text-neutral-500">
              ...
              "Saya mengalami masalah rambut di menit-menit terakhir dan Enta Salon menyelamatkan hari itu! Stafnya dapat segera menangani saya dan mereka melakukan pekerjaan yang luar biasa. Saya sangat berterima kasih kepada mereka atas profesionalisme dan keahlian mereka. Saya pasti akan kembali lagi!"
            </p>
            <ul class="mb-0 flex items-center justify-center">
              <li>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-5 w-5 text-yellow-500">
    ...
    <section class="mb-12" id="offer-banner">
      ...
      <div class="bg-pink-600 alert alert-dismissible fade show fixed bottom-0 right-0 left-0 z-[1030] w-full py-4 px-6 text-white md:flex justify-between items-center text-center md:text-left">
        <div class="mb-4 md:mb-0 flex items-center flex-wrap justify-center md:justify-start">
          ...
          <strong class="mr-1">Penawaran terbatas!</strong> Dapatkan diskon besar sekarang sebelum terlambat
        </div>
...
<div
  ...
  <div class="flex justify-center">
    <a href="https://www.facebook.com/endah.hidayati.94/" class="mr-6 text-neutral-600 dark:text-neutral-200">
      <svg
    ...
    <a href="https://www.instagram.com/entasalon/" class="mr-6 text-neutral-600 dark:text-neutral-200">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-4 w-4"
        fill="currentColor"
