            ...
            <div class="grid w-full grid-cols-1 items-start gap-x-6 gap-y-8 sm:grid-cols-12 lg:gap-x-8">
                ...
                <div class="sm:col-span-8 lg:col-span-7">
                    ...
                    <section aria-labelledby="information-heading" class="mt-2">
                        ...
                        <p class="text-2xl text-gray-900">Rp.  {{ number_format($service->price, 2, '.', ',') }}
                        </p>
...
{{--                                    'percentageAppointmentsChangeLastWeek' => $percentageAppointmentsChangeLastWeek,--}}
                                    ...
                                    <table class="border-collapse w-full">
                                        ...
                                        <tr>
                                            ...
                                            <td class="border p-2"> Rp.  {{ number_format($totalRevenueLastWeek, 2, '.', ',') }}</td>
                                            <td class="border p-2">
                                            ...
                                            <td class="border p-2">Rp.  {{ number_format($totalRevenue, 2, '.', ',') }}</td>
                                        </tr>
                                        <tr>
                                            <td class="border p-2">Revenue (Last Month)</td>
                                            <td class="border p-2">Rp.  {{ number_format($totalRevenueLastMonth, 2, '.', ',') }}</td>
                                            <td class="border p-2">
