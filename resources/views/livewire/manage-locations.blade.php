            ...
            <x-dialog-modal wire:model="confirmingLocationAdd">
                ...
                <x-slot name="content">
                    ...
                    <div>
                        ...
                        <input type="tel" wire:model="location.telephone_number" minlength="10" maxlength="12" id="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-pink-500 focus:border-pink-500 sm:text-sm">
